...
.header h1{ background-image:url({$config_siteurl}statics/images/hust_math_logo.png);background-repeat:no-repeat;width:454px;height:145px;line-height:150px;overflow:hidden;font-size:0}
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright &copy;1953 - {:date('Y')} , 华中科技大学数学与统计学院.</p>
      <p class="copyright_ch"><a href="http://maths.hust.edu.cn" target="_blank">http://maths.hust.edu.cn</a></p>
    </div>
  </div>
</div>
