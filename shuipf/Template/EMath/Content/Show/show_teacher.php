				...
				<div class="list-col1 pull-left">
					...
					<div class="menu menu-stacked mg-b-10">
						<ul>
							...
							<li><a href="{$Config_siteurl}index.php?a=shows&catid=2&id=5">教师队伍</a></li>
							<li><a href="{$Config_siteurl}index.php?a=shows&catid=2&id=525">师资结构</a></li>
						</ul>
					</div>
					<!--左侧导航 end-->
				</div>
				...
				<div class="list-col2 pull-right">
					<div class="article_article_left pull-left">
						<div class="article_con">
							...
							<p class="info">更新时间:{$updatetime}&nbsp;&nbsp;&nbsp;   您是第<span id="hits">0</span>位浏览者 </p>
							<div class="tool_con">
