...
<head>
	...
	<script type="text/javascript" src="__PUBLIC__/login/js/ts_ajax.js"></script>
	<script type="text/javascript">
		var verify_url = "<?php echo U(verify);?>&rand=";
		var login_url = "<?php echo U(login);?>";
		var teacher_url = "<?php echo C(t_login);?>";
		var student_url = "<?php echo C(s_login);?>";
	</script>
		...
		<div class="login-aside">
			...
			<div id="o-box-down"  style="table-layout:fixed;">
   				<form>
   					<div>
   						<label>
   							<input name="user_type" type="radio" value="1" checked="true"/>
   							教师
   						</label>
   						<label>
   							<input name="user_type" type="radio" value="2"/>
   							学生
   						</label>
   					</div>
